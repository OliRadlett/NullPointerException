...
/**
 * Page used to search for jobs and display result in a table ordered by relevance
 *
...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src = "scripts/filterSearchJobs.js"></script>
			...
			<div class = "col-sm-12">
				...
				<form class = "form-inline" onsubmit="return false;">
					<div class="form-group mx-sm-3 mb-2">
						<input class = "form-control" placeholder="Search jobs..." id = "search"/>
					</div>
